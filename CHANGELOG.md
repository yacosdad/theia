...
- [core] moved `endpoint.ts` from `browser` to `common`. [#10153](https://github.com/eclipse-theia/theia/pull/10153)
- [core] moved `nls.ts` from `browser` to `common`. [#10153](https://github.com/eclipse-theia/theia/pull/10153)
