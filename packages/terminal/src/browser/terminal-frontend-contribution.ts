...
import {
    ApplicationShell, KeybindingContribution, KeyCode, Key, codicon,
    KeybindingRegistry, Widget, LabelProvider, WidgetOpenerOptions, StorageService, QuickInputService, CommonCommands
...
export namespace TerminalCommands {
    ...
    }, 'workbench.action.terminal.newInActiveWorkspace', TERMINAL_CATEGORY_KEY);
    export const TERMINAL_CLEAR = Command.toLocalizedCommand({
        id: 'terminal:clear',
        category: TERMINAL_CATEGORY,
        label: 'Clear Terminal'
    }, 'workbench.action.terminal.clear', TERMINAL_CATEGORY_KEY);
